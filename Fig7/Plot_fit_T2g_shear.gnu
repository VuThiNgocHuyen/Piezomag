...
plot 0 notitle with lines dt 2 lw 3 lt rgb "black", \
     'data_shear_T2g' using ($4*100):($1*-1000) notitle with points pt 5 ps 1.0 lt rgb "dark-green",\
     'data_shear_T2g_noSOC' using ($4*100):($1*-1000) notitle with points pt 4 ps 1.0 lt rgb "dark-green"
