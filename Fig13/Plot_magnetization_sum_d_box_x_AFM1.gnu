...
set output "Magnetization_orbital_x_sum_AFM1.eps"
unset title
...
plot 'Mag_orb_x_sum_AFM1.dat' u 1:(-$2) w boxes lc rgb "pink" notitle,\
     'Mag_orb_x_sum_AFM1.dat' u 3:(-$4) w boxes lc rgb "red" notitle  
