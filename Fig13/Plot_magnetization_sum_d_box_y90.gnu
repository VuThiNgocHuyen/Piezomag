...
set output "Magnetization_orbital_y_sum_AFM2.eps"
unset title
...
plot 'Mag_orb_y_sum_AFM2.dat' u 1:(-$2) w boxes lc rgb "light-blue" notitle,\
     'Mag_orb_y_sum_AFM2.dat' u 3:(-$4) w boxes lc rgb "blue" notitle  
