...
plot 0 notitle with lines dt 2 lw 3 lt rgb "black", \
     'data_bias_T1g_Ni' using ($4*100):($3*-1000) notitle with points pt 5 ps 1.7 lt rgb "web-blue",\
     'data_bias_T1g_Cu' using ($4*100):($3*-1000) notitle with points pt 7 ps 1.7 lt rgb "web-blue"
