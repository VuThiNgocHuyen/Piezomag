...
set yrange [100.5 : 101.5]
set xrange [0: 810]

set arrow from 0.0,0.0 to 800,0.0 nohead dt '-' lw 2 lt rgb "black" front

plot 'data_Ge' u ($4)*100:($7) lt -1 pi -6 pt 5 ps 1.7 lc rgb "green" title "Mn_3Ge",\
'data_Ge' u ($4)*100:($7) w l lw 5 lc rgb "green" notitle ,\
