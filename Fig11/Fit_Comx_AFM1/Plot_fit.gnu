...
Mx_model_Sn(x) = n_Sn + q11_Sn * x
Mx_model_Ge(x) = n_Ge + q11_Ge * x
...
fit Mx_model_Sn(x) 'data_Sn' using 4:($1*-1) via n_Sn, q11_Sn
print "Sn: q11_Sn * 18.9655 =", q11_Sn * 18.9655
fit Mx_model_Ge(x) 'data_Ge' using 4:($1*-1) via n_Ge, q11_Ge
print "Ge: q11_Ge * 18.9655 =", q11_Ge * 18.9655
...
plot     'data_Ge' using 4:($1*-1) notitle with points pt 5 ps 1.3 lt rgb "green", \
     [0:7.77] Mx_model_Ge(x) notitle with lines lw 3 lt rgb "green", \
     'data_Sn' using 4:($1*-1) notitle with points pt 7 ps 1.3 lt rgb "royalblue", \
     [0:6.35] Mx_model_Sn(x) notitle with lines lw 3 lt rgb "royalblue", \
