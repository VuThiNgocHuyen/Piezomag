...
Mx_model_Sn(x) = n_Sn + q21_Sn * x
Mx_model_Ge(x) = n_Ge + q21_Ge * x
...
fit Mx_model_Sn(x) 'data_Sn' using 4:($2*-1) via n_Sn, q21_Sn
print "Sn: q21_Sn * 18.9655 =", q21_Sn * 18.9655
fit Mx_model_Ge(x) 'data_Ge' using 4:($2*-1) via n_Ge, q21_Ge
print "Ge: q21_Ge * 18.9655 =", q21_Ge * 18.9655
...
plot     'data_Ge' using 4:($2*-1) notitle with points pt 5 ps 1.3 lt rgb "green", \
     [0:7.79] Mx_model_Ge(x) notitle with lines lw 3 lt rgb "green", \
     'data_Sn' using 4:($2*-1) notitle with points pt 7 ps 1.3 lt rgb "royalblue", \
