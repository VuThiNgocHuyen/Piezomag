...
fit Mx_model_Ni(x) 'data_Ni' using 6:($1*-1) via n12_Ni, q12_Ni
print "Ni: q12_Ni * 18.9655 =", q12_Ni * 18.9655
fit Mz_model_Ni(x) 'data_Ni' using 6:($3*-1) via n11_Ni, q11_Ni
print "Ni: q11_Ni * 18.9655 =", q11_Ni * 18.9655

fit Mx_model_Cu(x) 'data_Cu' using 6:($1*-1) via n12_Cu, q12_Cu
print "Cu: q12_Cu * 18.9655 =", q12_Cu * 18.9655
fit Mz_model_Cu(x) 'data_Cu' using 6:($3*-1) via n11_Cu, q11_Cu
print "Cu: q11_Cu * 18.9655 =", q11_Cu * 18.9655

fit Mx_model_Zn(x) 'data_Zn' using 6:($1*-1) via n12_Zn, q12_Zn
print "Zn: q12_Zn * 18.9655 =", q12_Zn * 18.9655
fit Mz_model_Zn(x) 'data_Zn' using 6:($3*-1) via n11_Zn, q11_Zn
print "Zn: q11_Zn * 18.9655 =", q11_Zn * 18.9655

fit Mx_model_Ga(x) 'data_Ga' using 6:($1*-1) via n12_Ga, q12_Ga
print "Ga: q12_Ga * 18.9655 =", q12_Ga * 18.9655
fit Mz_model_Ga(x) 'data_Ga' using 6:($3*-1) via n11_Ga, q11_Ga
...
plot 0 notitle with lines dt 2 lw 3 lt rgb "black", \
     'data_Ni_T2g' using 6:($1*-1) notitle with points pt 5 ps 1.7 lt rgb "dark-green", \
     [0:24.9] Mx_model_Ni(x) notitle with lines lw 3 lt rgb "dark-green", \
     'data_Cu_T2g' using 6:($1*-1) notitle with points pt 7 ps 1.7 lt rgb "dark-green", \
     [0:19.81] Mx_model_Cu(x) notitle with lines lw 3 lt rgb "dark-green", \
     'data_Zn_T2g' using 6:($1*-1) notitle with points pt 9 ps 1.7 lt rgb "dark-green", \
     [0:22.03] Mx_model_Zn(x) notitle with lines lw 3 lt rgb "dark-green", \
     'data_Ga_T2g' using 6:($1*-1) notitle with points pt 13 ps 1.7 lt rgb "dark-green", \
